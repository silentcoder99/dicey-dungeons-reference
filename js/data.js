...
//
// Equipment `weaken`: the same thing mirrored -- what changes when the equipment is weakened, the
// game's reverse of an upgrade. Same partial-override shape, same allowed keys, same `{}` for "the
// card doesn't change", and the name's "-" and the drained colors are likewise the renderer's job.
// Sourced from the "Weakened Effect" / "Weakened Requirements" rows, which a couple of pages label
// "Downgraded" instead (Whip, Lament). Two things to watch, beyond the wording rule above:
//   - Nothing anywhere has a "Weakened Size" row, so a weakened card is never a different shape.
//   - Where a page carries a second stats table for the enemy/Jester version of the card, the first
//     table is the one that counts, as it is for upgrades (Sneeze and Spike disagree between their
//     two tables; both take the first).
// Dire Wolf Howl is the one entry whose rows are qualified: its "Weakened Effect (if upgraded)"
// describes weakening an already-upgraded card, which this site doesn't model, so only its
// "Weakened Requirements (if not upgraded)" row applies. Mystery Box is the one entry the wiki
// gives no weakened form at all, hence `weaken: {}`.
//
// There is no card image for a weakened card -- the wiki has one image per equipment, the regular
// one -- so unlike everything else here these rows are the only reference there is.
...
const EQUIPMENT = {
  ...
  blight: {
    ...
    weaken: {
      effect: [
        { type: "text", text: "Increase " },
        { type: "icon", icon: "poison" },
        { type: "text", text: " poison" },
        { type: "lineBreak" },
        { type: "text", text: "by 50%" },
      ],
    },
  },
  bloodSuck: {
  ...
  chocolateCookie: {
    ...
    weaken: {
      effect: [
        { type: "text", text: "Next equipment gets" },
        { type: "lineBreak" },
  ...
  crystallize: {
    ...
    weaken: {
      effect: [
        { type: "text", text: "Create a random" },
        { type: "lineBreak" },
        { type: "text", text: "weakened crystal weapon" },
      ],
    },
  },
  darkShadow: {
  ...
  deepSeaHowl: {
    ...
    weaken: {
      requirement: [{ type: "exact", value: 4 }, { type: "exact", value: 4 }],
    },
  },
  direWolfHowl: {
    name: "Dire Wolf Howl",
    ...
    weaken: {
      requirement: [{ type: "exact", value: 6 }, { type: "exact", value: 6 }],
    },
  },
  dustCloud: {
    name: "Dust Cloud",
  ...
  electromagnet: {
    ...
    weaken: {
      effect: [
        ...
        { type: "text", text: " damage" },
        { type: "lineBreak" },
        { type: "text", text: "Damage doesn't increase" },
      ],
    },
  },
  fireBreath: {
  ...
  fists: {
    ...
    weaken: {
      effect: [
        ...
        { type: "text", text: " damage" },
        { type: "lineBreak" },
        { type: "text", text: "(1 use this turn)", muted: true },
      ],
    },
  },
  flameSpell: {
  ...
  lock2: {
    ...
    weaken: {
      requirement: [{ type: "exact", value: 2 }, { type: "exact", value: 2 }],
    },
  },
  lock3: {
    name: "Lock 3",
    ...
    weaken: {
      requirement: [{ type: "exact", value: 3 }, { type: "exact", value: 3 }],
    },
  },
  lock4: {
    name: "Lock 4",
  ...
  lock5: {
    ...
    weaken: {
      requirement: [{ type: "exact", value: 5 }, { type: "exact", value: 5 }],
    },
  },
  lock6: {
    name: "Lock 6",
  ...
  nightmare: {
    ...
    weaken: {
      effect: [
        { type: "text", text: "Do " },
        { type: "icon", icon: "sword", value: 998 },
        { type: "text", text: " damage" },
      ],
    },
  },
  ...
  rottenCore: {
    ...
    weaken: {
      effect: [
        { type: "text", text: "Reduce health by" },
        { type: "lineBreak" },
        { type: "text", text: "one third" },
      ],
    },
  },
  runAway: {
  ...
  sneeze: {
    ...
    weaken: {
      ...
      effect: [
        { type: "text", text: "Reduce the countdowns" },
        { type: "lineBreak" },
        { type: "text", text: "on all equipment by 6" },
      ],
    },
  },
  snowball: {
  ...
  spanner: {
    ...
    weaken: {
      requirement: [{ type: "max", value: 3 }, { type: "max", value: 3 }],
    },
  },
  spike: {
    name: "Spike",
  ...
  twoHandedSword: {
    ...
    weaken: {
      requirement: [{ type: "max", value: 5 }, { type: "max", value: 5 }],
    },
  },
  venusFlyTrap: {
    name: "Venus Fly Trap",
  ...
  // ---------- Warrior, episode 1 ----------
  // What the player buys, finds in chests and upgrades at the anvil, rather than what an enemy
  // carries. Colors sampled from each card image with scripts/sample-card-colors.js.

  boomerang: {
    name: "Boomerang",
    color: { header: "#fd5e6c", body: "#aa363b" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
      ...
      { type: "text", text: "2x" },
      { type: "dieSlot" },
      { type: "text", text: " to enemy," },
      { type: "lineBreak" },
      { type: "text", text: "but " },
      { type: "icon", icon: "sword" },
      { type: "dieSlot" },
      { type: "text", text: " to yourself" },
    ],
    upgrade: {
      effect: [
        { type: "text", text: "Do " },
  ...
  buckler: {
    name: "Buckler",
    color: { header: "#ff9048", body: "#ac4f24", slot: "#c56125" },
    size: 1,
    requirement: { type: "countdown", value: 7 },
    bonusDieFace: null,
    effect: [
  ...
  bump: {
    name: "Bump",
    color: { header: "#5da66f", body: "#256e43" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
  ...
  counterSpell: {
    name: "Counter Spell",
    color: { header: "#b496ec", body: "#684286" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
      { type: "text", text: "If enemy rolls " },
      { type: "dieSlot" },
      { type: "text", text: "," },
      { type: "lineBreak" },
      { type: "text", text: "that dice is locked" },
    ],
    // The upgrade adds a second use, which the card has no room for as a third line -- the wiki
    // has it reworded ("Lock enemy dice that roll []"), which fits in two.
    upgrade: {
      effect: [
        { type: "text", text: "Lock enemy dice that" },
        { type: "lineBreak" },
        { type: "text", text: "roll " },
        { type: "dieSlot" },
        { type: "text", text: " " },
  ...
  crystalSword: {
    name: "Crystal Sword",
    color: { header: "#fd5e6c", body: "#9d2e37" },
    size: 2,
    requirement: { type: "max", value: 5 },
    bonusDieFace: null,
    effect: [
    ...
    // The wiki's second table is the Jester's alternate upgrade (Max 3, but no longer once per
    // battle); the first is the one the Warrior and Inventor get.
    upgrade: {
      size: 1,
    },
    weaken: {
  ...
  dagger: {
    name: "Dagger",
    color: { header: "#fd5e6c", body: "#993937" },
    size: 1,
    requirement: { type: "max", value: 3 },
    bonusDieFace: null,
    effect: [
  ...
  firstAidKit: {
    name: "First Aid Kit",
    color: { header: "#5da66f", body: "#386739", slot: "#2e7f40" },
    size: 1,
    requirement: { type: "countdown", value: 16 },
    bonusDieFace: null,
    effect: [
      { type: "text", text: "Heal " },
      { type: "icon", icon: "heal", value: 8 },
      { type: "text", text: " health" },
    ],
    upgrade: {
      requirement: { type: "countdown", value: 12 },
  ...
  ironShield: {
    name: "Iron Shield",
    color: { header: "#ff9048", body: "#bd5e2c" },
    size: 2,
    requirement: null,
    bonusDieFace: null,
    effect: [
  ...
  jugglingBall: {
    name: "Juggling Ball",
    color: { header: "#fd5e6c", body: "#a63d40" },
    size: 1,
    requirement: { type: "max", value: 3 },
    bonusDieFace: null,
    effect: [
  ...
  lightningRod: {
    name: "Lightning Rod",
    color: { header: "#fd5e6c", body: "#9a2833" },
    size: 2,
    requirement: { type: "doubles" },
    bonusDieFace: null,
    // The card prints the charge it currently holds, which is zero outside a fight.
    effect: [
      { type: "text", text: "Discharge " },
      { type: "icon", icon: "sword", value: 0 },
      { type: "text", text: " damage" },
      { type: "lineBreak" },
      { type: "text", text: "Take damage to charge" },
    ],
    upgrade: {
      requirement: { type: "even" },
    },
    weaken: {
      effect: [
        { type: "text", text: "Discharge, but do" },
        { type: "lineBreak" },
        { type: "text", text: "zero " },
        { type: "icon", icon: "sword" },
        { type: "text", text: " damage" },
  ...
  nightstick: {
    ...
    bonusDieFace: null,
    effect: [
      { type: "icon", icon: "shock", value: "Shocks" },
      { type: "text", text: " the enemy" },
      { type: "lineBreak" },
      { type: "text", text: "(Reuseable)", muted: true },
    ],
    upgrade: {
  ...
  snakeEyeCharm: {
    ...
    color: { header: "#5da66f", body: "#326636", slot: "#2e7f40" },
    size: 1,
    requirement: { type: "countdown", value: 6 },
    bonusDieFace: null,
    effect: [
      { type: "text", text: "Roll 2 ones" },
    ],
    upgrade: {
      requirement: { type: "countdown", value: 3 },
    },
    weaken: {
      effect: [
        { type: "text", text: "Roll 1 one" },
      ],
    },
  },
  spatula: {
    name: "Spatula",
    color: { header: "#5da66f", body: "#2e6433" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
      { type: "text", text: "Flip a dice upside down" },
    ],
    upgrade: {
      effect: [
        { type: "text", text: "Flip a dice upside down" },
  ...
  staff: {
    name: "Staff",
    color: { header: "#fd5e6c", body: "#902c2d", slot: "#ac2c38" },
    size: 2,
    requirement: { type: "countdown", value: 8 },
    bonusDieFace: null,
    effect: [
  ...
  targetShield: {
    name: "Target Shield",
    color: { header: "#ff9048", body: "#99562e" },
    size: 1,
    requirement: { type: "max", value: 2 },
    bonusDieFace: null,
    effect: [
  ...
  toxicOoze: {
    name: "Toxic Ooze",
    color: { header: "#b496ec", body: "#79518e" },
    size: 2,
    requirement: null,
    bonusDieFace: null,
    effect: [
  ...
  lockpick: {
    ...
    weaken: {
      effect: [
        { type: "text", text: "Split value in two" },
      ],
    },
  },
  nudgeblade: {
  ...
  skeletonKey: {
    ...
    weaken: {
      requirement: [{ type: "exact", value: 2 }, { type: "exact", value: 2 }],
      effect: [
        { type: "text", text: "Set all dice to 2" },
      ],
    },
  },
  ...
  // ---------- Witch, episode 1 ----------
  // The three spells here are cast from the Witch's spellbook, which the wiki's image shows as a
  // bar of sockets under the card. That isn't part of the card, so it goes in `note`.

  absoluteZero: {
    name: "Absolute Zero",
    color: { header: "#7bc8ff", body: "#2a5880", slot: "#3a7ba8" },
    size: 1,
    requirement: { type: "countdown", value: 24 },
    bonusDieFace: null,
    note: "Costs 2 dice to cast from the spellbook.",
    effect: [
      { type: "text", text: "Do " },
      { type: "icon", icon: "ice", value: 25 },
      { type: "text", text: " damage," },
      { type: "lineBreak" },
      { type: "text", text: "freeze all dice" },
    ],
    ...
    weaken: {
      effect: [
        { type: "text", text: "Do " },
        { type: "icon", icon: "ice", value: 12 },
        { type: "text", text: " damage," },
        { type: "lineBreak" },
        { type: "text", text: "freeze a dice" },
      ],
    },
  },
  blizzard: {
    name: "Blizzard",
    color: { header: "#7bc8ff", body: "#395f7f" },
    size: 1,
    requirement: [null, null],
    bonusDieFace: null,
    effect: [
  ...
  crucible: {
    ...
    bonusDieFace: null,
    effect: [
      { type: "text", text: "Roll a burning dice" },
      { type: "lineBreak" },
      { type: "text", text: "(Reuseable)", muted: true },
    ],
    upgrade: {
      effect: [
        { type: "text", text: "Roll four new" },
        { type: "lineBreak" },
        { type: "text", text: "burning dice" },
      ],
    },
    weaken: {
      effect: [
  ...
  duplicate: {
    name: "Duplicate",
    color: { header: "#5da66f", body: "#2d693b" },
    size: 1,
    requirement: { type: "min", value: 4 },
    bonusDieFace: null,
    effect: [
  ...
  furySpell: {
    name: "Fury Spell",
    color: { header: "#b496ec", body: "#5e4183" },
    size: 1,
    requirement: { type: "exact", value: 6 },
    bonusDieFace: null,
    note: "Costs 2 dice to cast from the spellbook.",
  ...
  goldCauldron: {
    name: "Gold Cauldron",
    color: { header: "#cdb94b", body: "#966c2a" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
      ...
      { type: "text", text: " damage," },
      { type: "lineBreak" },
      { type: "text", text: "get an even dice" },
    ],
    // The second use needs a line of its own, so the first shortens to the "dmg" the game uses on
    // cards that are tight. Silver Cauldron's upgrade is worded to match.
    upgrade: {
      effect: [
        { type: "text", text: "Do " },
        { type: "icon", icon: "sword", value: 1 },
        { type: "text", text: " dmg, even dice" },
        { type: "lineBreak" },
        { type: "text", text: "(2 uses this turn)", muted: true },
      ],
    },
  ...
  hex: {
    name: "Hex",
    color: { header: "#b496ec", body: "#745893" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
  ...
  illuminate: {
    name: "Illuminate",
    color: { header: "#cdb94b", body: "#9b6c28" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
    ...
    // Twice the dice, but only on doubles -- the wiki has the upgrade tightening the requirement.
    upgrade: {
      requirement: { type: "doubles" },
      effect: [
        { type: "text", text: "Get 4x" },
        { type: "icon", icon: "dice" },
        { type: "dieSlot" },
        { type: "text", text: "s next turn" },
      ],
  ...
  inferno: {
    name: "Inferno",
    color: { header: "#fd5e6c", body: "#8f242d" },
    size: 1,
    requirement: [null, null],
    bonusDieFace: null,
    effect: [
  ...
  lifeDrain: {
    name: "Life Drain",
    color: { header: "#fd5e6c", body: "#842431" },
    size: 1,
    requirement: { type: "max", value: 3 },
    bonusDieFace: null,
    effect: [
  ...
  lightningBolt: {
    name: "Lightning Bolt",
    color: { header: "#cdb94b", body: "#9e6c29" },
    size: 1,
    requirement: [null, null],
    bonusDieFace: null,
    effect: [
  ...
  magicDagger: {
    name: "Magic Dagger",
    color: { header: "#fd5e6c", body: "#902d38" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
  ...
  magicKey: {
    name: "Magic Key",
    color: { header: "#5da66f", body: "#2d6636" },
    size: 1,
    requirement: { type: "even" },
    bonusDieFace: null,
    effect: [
  ...
  meteor: {
    name: "Meteor",
    color: { header: "#fd5e6c", body: "#892938", slot: "#ac2c38" },
    size: 1,
    requirement: { type: "countdown", value: 20 },
    bonusDieFace: null,
    note: "Costs 2 dice to cast from the spellbook.",
    ...
    weaken: {
      effect: [
        { type: "text", text: "Do " },
        { type: "icon", icon: "fire", value: 10 },
        { type: "text", text: " damage," },
        { type: "lineBreak" },
        { type: "text", text: "burn a dice" },
      ],
    },
  },
  shockwave: {
    name: "Shockwave",
    color: { header: "#ff9048", body: "#ac683c" },
    size: 1,
    requirement: [null, null],
    bonusDieFace: null,
    effect: [
  ...
  silverCauldron: {
    ...
    color: { header: "#7b7b7b", body: "#434547" },
    size: 1,
    requirement: null,
    bonusDieFace: null,
    effect: [
      ...
      { type: "text", text: " damage," },
      { type: "lineBreak" },
      { type: "text", text: "get an odd dice" },
    ],
    upgrade: {
      effect: [
        { type: "text", text: "Do " },
        { type: "icon", icon: "sword", value: 1 },
        { type: "text", text: " dmg, odd dice" },
        { type: "lineBreak" },
        { type: "text", text: "(2 uses this turn)", muted: true },
      ],
    },
